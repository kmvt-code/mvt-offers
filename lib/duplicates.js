...
// Vendor identity lives in lib/vendors.js so the contact memory and the duplicate
// matcher cannot drift apart on what counts as the same vendor.
export { vendorKey, vendorsMatch } from './vendors';
import { vendorsMatch } from './vendors';
